...
import { Box, Stack, Title, Center, Loader, Paper, Text, Group, Button, SimpleGrid, TextInput, NumberInput, Select, Textarea, Divider, Table, ActionIcon, ThemeIcon, Tabs } from '@mantine/core'
