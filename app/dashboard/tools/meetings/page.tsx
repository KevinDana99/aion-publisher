...
import { Container, Stack, Title, Center, Loader, Paper, Text, Group, Button, SimpleGrid, Badge, ActionIcon, Box, Modal, TextInput, Select, Divider, ThemeIcon, Tabs, Anchor, Alert, Textarea } from '@mantine/core'
import { IoVideocam, IoAdd, IoTrash, IoLink, IoCalendar, IoTime, IoPerson, IoCheckmarkCircle, IoAlertCircle, IoOpen, IoSettings } from 'react-icons/io5'
      ...
      <Stack gap="xl">
        ...
        {!calendlyUrl && (
          <Alert icon={<IoAlertCircle size={18} />} title="Calendly no configurado" color="yellow">
            <Group justify="space-between">
              <Text size="sm">Configura tu URL de Calendly para generar enlaces automáticos de reunión.</Text>
              <Button 
                size="xs" 
                variant="light" 
                component={Link}
